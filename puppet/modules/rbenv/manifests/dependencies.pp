class rbenv::dependencies {
  ...
  if ! defined(Package['git-core']) {
    package { 'git': ensure => installed, name => 'git-core' }
  }
  ...
  if ! defined(Package['libxslt1-dev']) {
    package { 'libxslt1-dev': ensure => installed, alias =>'libxslt-dev' }
  }
}
